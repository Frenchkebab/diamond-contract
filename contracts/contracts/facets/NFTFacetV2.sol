...
contract NFTFacetV2 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function initialize(string calldata name_, string calldata symbol_) public {
        ...
        require(!dsERC721.initialized, "NFTFacet: Contract instance has already been initialized");
    ...
    function balanceOf(address owner) public view override returns (uint256) {
        ...
        LibERC721.ERC721DiamondStorage storage dsERC721 = LibERC721.diamondStorage();
        return dsERC721._balances[owner];
    }
    ...
    function getApproved(uint256 tokenId) public view virtual override returns (address) {
        _requireMinted(tokenId);
        LibERC721.ERC721DiamondStorage storage dsERC721 = LibERC721.diamondStorage();
        return dsERC721._tokenApprovals[tokenId];
    }
    ...
    function isApprovedForAll(address owner, address operator) public view virtual override returns (bool) {
        LibERC721.ERC721DiamondStorage storage dsERC721 = LibERC721.diamondStorage();
        return dsERC721._operatorApprovals[owner][operator];
    }
    ...
    function _ownerOf(uint256 tokenId) internal view virtual returns (address) {
        LibERC721.ERC721DiamondStorage storage dsERC721 = LibERC721.diamondStorage();
        return dsERC721._owners[tokenId];
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        unchecked {
            ...
            dsERC721._balances[to] += 1;
        }

        dsERC721._owners[tokenId] = to;
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        // Clear approvals
        delete dsERC721._tokenApprovals[tokenId];

        unchecked {
            // Cannot overflow, as that would require more tokens to be burned/transferred
            // out than the owner initially received through minting and transferring in.
            dsERC721._balances[owner] -= 1;
        }
        delete dsERC721._owners[tokenId];
    ...
    function _setApprovalForAll(address owner, address operator, bool approved) internal virtual {
        ...
        LibERC721.ERC721DiamondStorage storage dsERC721 = LibERC721.diamondStorage();
        dsERC721._operatorApprovals[owner][operator] = approved;
